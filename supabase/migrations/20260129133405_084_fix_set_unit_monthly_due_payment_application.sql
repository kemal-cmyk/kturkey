/*
  # Fix set_unit_monthly_due Payment Application Logic
  
  ## Problem
  The previous version had issues with:
  1. Not including applied_to_dues when re-inserting payments
  2. Potential logic issues with payment application to new dues
  3. Missing proper handling of payment currency conversions
  
  ## Solution
  Simplify the function to:
  1. Store payment data
  2. Delete old payments and dues
  3. Create new dues
  4. Re-insert payments with proper applied_to_dues calculation
  5. Manually update dues paid amounts based on re-inserted payments
*/
...
BEGIN
  ...
  IF v_payment_amounts IS NOT NULL THEN
    ...
    LOOP
      -- Apply payment to dues and collect applied dues info
      ...
      LOOP
        ...
        -- Update due with new paid amount
      ...
      -- Now re-insert the payment record WITHOUT triggering ledger creation
