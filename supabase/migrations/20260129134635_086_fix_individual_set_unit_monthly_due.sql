/*
  # Fix Individual Set Unit Monthly Due Function
  
  Same issue as the batch function: total_amount is a generated column
  and cannot be directly inserted. This function must only set base_amount.
*/
